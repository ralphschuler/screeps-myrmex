...
export function collectTelemetryEvidence() {
  ...
  return {
    ...
    gateInputs: {
      ...
      measuredCpuMilli: nominal.telemetry.window[9],
      authorityFailures: nominal.telemetry.window[7],
      ...
      industryOutput:
        nominal.telemetry.flows.labOutput +
        nominal.telemetry.flows.factoryOutput +
        nominal.telemetry.flows.powerOutput,
    },
    window: {
      ...
      industryOutput: final.telemetry.window[6],
      authorityFailures: final.telemetry.window[7],
      reserveViolations: final.telemetry.window[8],
      measuredCpuMilli: final.telemetry.window[9],
      droppedSamples: final.telemetry.window[10],
    },
    bounds: {
