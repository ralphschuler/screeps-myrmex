...
export const SOURCE_FEATURE_GATES: readonly FeatureGateDefinition[] = deepFreeze([
  ...
  { id: "phase1.growth", available: true, prerequisites: ["phase1.recovery"] },
  {
    id: "phase1.safety",
    available: true,
  ...
  },
  {
    id: "phase2.logistics",
    available: true,
    prerequisites: ["phase2.mining", "phase1.telemetry"],
  },
  {
    id: "phase2.links",
    available: true,
    prerequisites: ["phase2.layout", "phase2.mining", "phase2.logistics", "phase1.telemetry"],
  },
  {
    id: "phase2.maintenance",
    available: true,
    prerequisites: ["phase2.layout", "phase2.logistics", "phase2.links", "phase1.telemetry"],
  },
  {
    id: "phase2.industry",
    available: true,
