...
observation proves its exact target ID absent. One completed extension or tower evacuation may
remain paired with that receipt only when exact type, target, replacement, and receipt-within-
