...
Autonomous boost-manifest production, different role IDs or compounds, terminal destinations,
multiple obsolete labs, general layout-revision migration, defensive migration, and creep
dismantling remain outside this decision and issue #341.
