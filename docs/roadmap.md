...
- Issue #308 supersedes #284's road-removal step after current engine verification: compatible
  ...
  continue work. Autonomous boost manifest production, mixed-terminal boost work, general multi-
  step migration, defensive migration, and creep dismantling remain issue #99.
