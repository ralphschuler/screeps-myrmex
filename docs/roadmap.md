...
- Issue #308 supersedes #284's road-removal step after current engine verification: compatible
  ...
  issues #393, #395, #397, and #399 add the equivalent exact completed tower, spawn, reserve-link,
  and container pairs under the same gates. Unrelated active, mismatched, storage, failed, unsafe,
  same-tick, or incomplete evidence remains blocked. Uninterrupted same-structure storage/terminal
