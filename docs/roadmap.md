...
- Issue #308 supersedes #284's road-removal step after current engine verification: compatible
  ...
  issues #393, #395, #397, #399, and #401 add the equivalent exact completed tower, spawn,
  reserve-link, container, and lab pairs under the same gates. Every canonical lab stock/destination
  form shares the same source/replacement/interval identity. Unrelated active, mismatched, storage,
  failed, unsafe, same-tick, or incomplete evidence remains blocked. Uninterrupted same-structure
